...
\begin{document}
    ...
    \section{Education}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item \textbf{Relevant Coursework:} Computer Systems, Computer Security, Theoretical Computer Science, Functional Programming, Machine Learning, Imperative Computation (Data Structures \& Algorithms)
    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Graded 300+ student submissions in SML, providing technical feedback on correctness, efficiency, and style of recursive, parallel, and higher-order algorithms.
                \item Led weekly labs for 20+ students and collaborated with course staff on assignment design and grading.
            \end{highlights}
        \end{onecolentry}

        \begin{twocolentry}{
            \text{September 2025 - Present}}
            \textbf{Research Assistant, CERN CMS Experiment}
        \end{twocolentry}
        \begin{twocolentry}{
            \text{Pittsburgh, PA}}
            \textit{Carnegie Mellon University}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Built a training and evaluation pipeline in PyTorch and PyG for quantization-aware graph neural networks, processing particle physics datasets from raw ROOT files through feature extraction and graph construction.
                \item Analyzing CERN HGCAL detector data to prepare adaptation of transformer-based clustering models from synthetic to real particle physics data.
            \end{highlights}
        \end{onecolentry}
        \begin{twocolentry}{
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Developed a neural network with PyTorch to forecast households' annual cooling energy, engineering a 75\% accuracy improvement by implementing LightGBM-based feature selection and hyperparameter tuning.
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Projects}
        ...
        \begin{twocolentry}{\text{February 2026}}
            \textbf{PharmaSentinel} $|$ \textit{Python, React, TypeScript, Supabase, OpenAI API}
        \end{twocolentry}
        \vspace{0.10 cm}
        \begin{onecolentry} 
            \begin{highlights}
                \item Orchestrated a multi-agent pipeline using Python, OpenAI API, and Brave Search MCP to monitor inventory, analyze supply chain news, and query openFDA data to detect drug shortages and identify substitutes.
                \item Designed PostgreSQL triggers and Supabase Realtime listeners to detect inventory changes, re-run the agent pipeline, and push shortage alerts, resolutions, and draft purchase orders to a live dashboard.
            \end{highlights}            
        \end{onecolentry}
        \begin{twocolentry}{
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item \textbf{Dynamic Memory Allocator}: Implemented a malloc/free replacement using segregated free lists and coalescing, achieving 74.3\% utilization and 15,885 kops/sec throughput (top of class).
    ...
    \section{Skills}
        \begin{onecolentry}
            \textbf{Programming Languages:} Python, C, SQL, SML, OCaml, Dafny, x86-64 Assembly, R \newline
            \textbf{Frameworks/Libraries:} Pandas, NumPy, scikit-learn, PyTorch, OpenAI API, Supabase, MCP \newline
            \textbf{Developer Tools:} Git, Linux, GDB, Valgrind
        \end{onecolentry}
    \vspace{0.20 cm}
