...
\begin{document}
    ...
    \section{Projects}
        ...
        \begin{twocolentry}{\text{February 2026}}
            \textbf{PharmaSentinel} $|$ \textit{Python, PostgreSQL, Supabase, OpenAI API}
        \end{twocolentry}
        \vspace{0.06 cm}
        \begin{onecolentry} 
            \begin{highlights}
    ...
    \section{Skills}
        \begin{onecolentry}
            ...
            \textbf{AI \& Observability:} LangGraph, OpenTelemetry, OpenInference, Arize AX/Phoenix, MCP, OpenAI API \newline
