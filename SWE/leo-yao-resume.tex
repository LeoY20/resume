...
\begin{document}
    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Led weekly labs for 20+ students and held regular office hours.
                \item Graded 300+ student submissions in SML every week, providing technical feedback on correctness, efficiency, and style of recursive, parallel, and higher-order algorithms.
            \end{highlights}
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Built custom PyTorch/HGQ2 GNN and its training pipeline for FPGA deployment at CERN CMS, achieving 97\% reduction in loss compared to baseline model.
                \item Developing transformer-based particle clustering models and data pipeline for CERN HGCAL data.
            \end{highlights}
        \end{onecolentry}
        \begin{twocolentry}{
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Engineered a Python data pipeline (Pandas, NumPy) to clean, normalize, and extract features from structured energy datasets.
    ...
    \section{Projects}
        ...
        \begin{twocolentry}{\text{February 2026}}
            \textbf{PharmaSentinel} $|$ \textit{Python, PostgreSQL, Supabase, OpenAI API, openFDA, MCP}
        \end{twocolentry}
        \vspace{0.10 cm}
        \begin{onecolentry} 
            \begin{highlights}
                \item Engineered a multi-agent backend system in Python, orchestrating external REST APIs (OpenAI, openFDA) to automate real-time supply chain monitoring and substitute identification.
    ...
    \section{Skills}
        \begin{onecolentry}
            \textbf{Programming Languages:} Python, C, SQL, SML, x86-64 Assembly \newline
            \textbf{Backend \& Systems:} PostgreSQL, Supabase, OpenAI API, MCP, Linux \newline
            \textbf{Data \& ML:} PyTorch, Pandas, NumPy, scikit-learn \newline
            \textbf{Developer Tools:} Git, GDB, Valgrind
        \end{onecolentry}
    \vspace{0.20 cm}
