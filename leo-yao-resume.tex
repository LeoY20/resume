...
\begin{document}
    ...
    \section{Experience}
        ...
        \begin{twocolentry}{
            \textit{Pittsburgh, PA}}
            \textit{FastML Lab (Advised by Prof. Matteo Cremonesi)}
        \end{twocolentry}
        ...
        \begin{twocolentry}{
            \textit{Pittsburgh, PA}}
        \textit{CMU SPICE Lab (Advised by PhD Candidate Lauren Janicke)}
        \end{twocolentry}
    ...
    \section{Projects}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Developed a thread-safe concurrent file system with standard features (e.g. file renaming, file descriptor position management), optimizing multithreaded performance and correctness with mutex synchronization.
            \end{highlights}
        \end{onecolentry}
    \section{Leadership}
        \begin{twocolentry}{
