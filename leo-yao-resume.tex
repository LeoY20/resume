...
\begin{document}
    ...
    \section{Experience}
        ...
        \vspace{0.10 cm}
            \begin{highlights}
                \item Researching deployment of real-time machine learning algorithms for the CMS experiment at CERN LHC.
                \item Developing high-granularity quantization-aware training features for \href{https://github.com/sharc-lab/FlowGNN}{flowGNN}, a library 
                for deploying various types of Graph Neural Networks on FPGA chips in real-time.
            \end{highlights}
        \begin{twocolentry}{
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Visualized model performance using MatPlotLib; presented graphics in a poster to peers.
    ...
    \section{Skills}
        \begin{onecolentry}
            \textbf{Programming Languages:} Python, C, R, Java, Dafny, Standard ML, x86-64 Assembly \newline
